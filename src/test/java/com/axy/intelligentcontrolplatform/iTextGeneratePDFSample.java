...
import com.axy.intelligentcontrolplatform.basic.utils.iTextPDFUtil;
...
public class iTextGeneratePDFSample {
    //水印PDF
    public static final String DEST = "E:\\AxyDocuments\\demo_watermark.pdf";
    public static void main(String[] args) throws Exception {
//        PdfPCellEvent roundRectangle = new Samplepdf01.RoundRectangle();
        //测试pdf保存路径
        String filePath = "E:\\AxyDocuments\\demoxs.pdf";
//        Image image = Image.getInstance(IMG);
        ...
        //报告基础信息说明
        document.add(new Paragraph("报告方："+"墨鱼",iTextPDFUtil.getColorFont(BaseColor.BLACK,19,"宋体")));
        ...
        Image radarImage = Image.getInstance("E:/AxyDocuments/abc.png");
        cellMobileHeader = new PdfPCell(radarImage,true);
...
//        tableMobileHeader.addCell(iTextPDFUtil.addTitleCell(cellMobileHeader, 50, BaseColor.WHITE, 2, true));
        ...
        cellBaseInfo = new PdfPCell(new Phrase("墨鱼",iTextPDFUtil.getColorFont()));
        tableBaseInfo.addCell(iTextPDFUtil.addBaseCell(cellBaseInfo));
...
//        document.add(image);
        ...
        iTextPDFUtil.stringWaterMark(input1, output2, "墨鱼", 4, 5, 0.2f,45, 26,BaseColor.BLACK);//文字水印
